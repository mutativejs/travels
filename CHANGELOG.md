...
- Reject semantic comparisons for unsupported prototypes, built-in subclasses, non-durable own-property shapes, and RegExp cursors whose observable state cannot be preserved safely.
